...
class DatePickerForm extends React.Component { // eslint-disable-line react/prefer-stateless-function
  ...
  this.props.saveDate([date.format('DD/MM/YYYY'), 'pickUpDate'])
  }
  handleChangeReturn(date) {
    this.setState({
      endDate: date
    })
  this.props.saveDate([date.format('DD/MM/YYYY'), 'returnDate'])
  }
    ...
    return (
      <div  className="row topDatePicker centered">
        <div  className="divLabelDate">
          <span className="spanWhite">When are you going to pick it up?</span>
        </div>
        <div className='divWhen'>
          <div className='columnPaddingzero columnDatePicker'>
            ...
            <span id='spanPickUpDate' className='out '>Select a date</span>
          </div>
          <div className="selectDivHour">
            ...
            />
            <span id='spanPickUpTime' className='out'>Select time</span>

          </div>
        </div>
        <div className="divLabelDate">
          <span className="spanWhite">When will you deliver it?</span>
        </div>
        <div className='divWhen'>
          <div className='columnPaddingzero'>
            ...
            <span id='spanreturnDate' className='out '>Select time</span>
          </div>
          <div className="selectDivHour">
            <Select className="selectHour"
              ...
              placeholder = {this.state.options[0].label}
            />
            <span id='spanreturnTime' className='out '>Select time</span>
